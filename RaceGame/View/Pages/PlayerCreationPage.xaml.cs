...
namespace RaceGame
{
    ...
    public partial class PlayerCreationPage : BasePage
    {
        public PlayerCreationPage(RaceGameRepository repository)
        {
            InitializeComponent();
            this.DataContext = new PlayerCreationViewModel(this, repository);
        }
